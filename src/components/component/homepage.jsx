          ...
          <Link href="/parking">
            <Card className="w-full cursor-pointer">
              <img
                ...
                width="283" />
              <div className="p-4">
                <h2 className="text-lg font-semibold">TSGS Parking Spot</h2>
          ...
          <Link href="/events">
            <Card className="w-full cursor-pointer">
              <img
                ...
                width="283" />
              <div className="p-4">
                <h2 className="text-lg font-semibold">TSGS Events</h2>
                <p className="text-sm text-gray-600 mt-2">
          ...
          <Link href="/hospital">
            <Card className="w-full cursor-pointer col-span-1 md:col-span-2">
              <img
                ...
                width="283" />
              <div className="p-4">
                <h2 className="text-lg font-semibold">TSGS Hospital</h2>
                <p className="text-sm text-gray-600 mt-2">
